...
public class RecipeLoader extends AsyncTaskLoader<List<RecipeItem>> {
    ...
    @Override
    public void deliverResult(List<RecipeItem> data) {
        if (isReset()) {
    ...
    @Override
    public void onCanceled(List<RecipeItem> data) {
    ...
    private void releaseResources(List<RecipeItem> data) {
